...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnBlue, btnYellow, btnRed, btnGreen, playBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // get view elements
        btnRed = findViewById(R.id.btnBlue);
        btnGreen = findViewById(R.id.btnRed);
        btnBlue = findViewById(R.id.btnGreen);
        btnYellow = findViewById(R.id.btnYellow);
        playBtn = findViewById(R.id.btnGo);

        tv_UserDisplay = findViewById(R.id.TV_UserDisplay);
        tv_score = findViewById(R.id.tvScore);
        tv_level = findViewById(R.id.tvCurLvl);
    ...
    private void LightButtons(){
        if(currentSequence != null){
            ...
            switch (currentSequence[currentButtonToLightIndex]){
                case 0: // cat
                    StartHighlight(btnRed);
                    break;
                case  1: // dog
                    StartHighlight(btnGreen);
                    break;
                case 2: // mouse
                    StartHighlight(btnYellow);
                    break;
                case  3: // monkey
                    StartHighlight(btnBlue);
                    break;
            }
