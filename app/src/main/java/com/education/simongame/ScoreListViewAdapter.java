...
public class ScoreListViewAdapter extends ArrayAdapter<HighScoreScreen> {
        public ScoreListViewAdapter(@NonNull Context context, List<HighScoreScreen> itemsList) {
